...
%class.Greeter = type { i8 }

$_ZN7Greeter8sayHelloEv = comdat any

@_ZSt4cout = external dso_local global %"class.std::basic_ostream", align 8
@.str = private unnamed_addr constant [15 x i8] c"Hello from C++\00", align 1

; Function Attrs: mustprogress noinline optnone uwtable
define dso_local void @_Z12cpp_functionv() #0 {
  %1 = alloca %class.Greeter, align 1
  call void @_ZN7Greeter8sayHelloEv(ptr noundef nonnull align 1 dereferenceable(1) %1)
  ret void
}

; Function Attrs: mustprogress noinline optnone uwtable
define linkonce_odr dso_local void @_ZN7Greeter8sayHelloEv(ptr noundef nonnull align 1 dereferenceable(1) %0) #0 comdat align 2 {
