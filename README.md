...
13. **[13_cross_language_linking/](examples/13_cross_language_linking/)**: Project Integration.
...
3.  **Build the Custom Pass (Advanced)**:
    ```bash
    cd examples/05_passes
    mkdir build && cd build
    cmake ..
    make
    # Run the pass:
    # opt -load ./HelloPass.so -hello < ../../01_basics/source.bc > /dev/null
    ```
